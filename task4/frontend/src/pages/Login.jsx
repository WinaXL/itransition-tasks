...
export default function Login() {
  const { login, kickMsg, setKickMsg } = useAuth();
  ...
  // Show kick notification if redirected from a kicked session.
  const notification = kickMsg;
  useEffect(() => () => setKickMsg(''), [setKickMsg]);
